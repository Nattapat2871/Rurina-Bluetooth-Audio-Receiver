...
* **📥 System Tray Integration:** Minimize the app to the taskbar tray to keep it running quietly in the background without cluttering your workspace.
* **📱 Multi-Device Support:** Automatically lists all compatible paired devices for quick switching.

## 💻 System Requirements

* **OS:** Windows 10 (Version 2004 or newer) or Windows 11.
* **Hardware:** A working Bluetooth adapter on your PC.
* **Framework:** .NET 10.0 (if compiling from source).

## 🚀 How to Use

### Option 1: Using the Pre-built Release (Recommended)
1. Download the latest `.exe` file from the [Releases](../../releases) page.
2. Ensure your phone or tablet is already paired with your PC via the standard Windows Bluetooth Settings.
3. Run `RurinaAudio-Receiver.exe`. The app will automatically detect your device!
